...
function Footer() {
    return (
        <>
            <footer className="bg-snow mx-auto max-w-full px-2 sm:px-6 lg:px-8 mt-14 shadow-lg">
                ...
                <div className="bg-gray-100">
                    <div className="container py-6 mx-auto flex items-center sm:flex-row flex-col">
                        <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                            <span className="ml-3 text-4xl font-logo font-semibold">LuKa</span>
                        </a>
                        <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start me-10 gap-5">
                            <a className="text-gray-500 hover:scale-125 duration-75" href='#'>
                                <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
                                    <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                                </svg>
                            </a>
                            <a className="ml-3 text-gray-500 hover:scale-125 duration-75" href='#'>
                                <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
